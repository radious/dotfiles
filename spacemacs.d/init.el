...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(yaml
     ...
     org
     (osx :variables mac-command-modifier "meta")
     python
     ruby
     rust
     spell-checking
   ...
   dotspacemacs-additional-packages '(smtpmail-multi)
...
you should place your code here."
  (when (fboundp 'dotspacemacs/user-config-local)
